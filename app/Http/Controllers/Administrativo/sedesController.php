...
use App\Models\Administrativo\RNL_REGIONAL;
use App\Models\Administrativo\DEP_DANE_DEPARTAMENTO;
use App\Models\Administrativo\MUN_DANE_MUNICIPIO;
use App\Models\Administrativo\REG_REGIMEN;
...
{    
    public function index(){  
        //lista tipo sede
        $listaTipoSede = self::listaTipoSede();

        //lista regional
        $listaRegional = self::listaRegional();

        //lista estado
        $listaEstados = self::listaEstados();

        //lista departamentos
        $listaDepartamentos = self::listaDepartamentos();

        // lista seccional
        $listaSeccional = self::listaSeccional();

        //lista tipo
        $listaTipo = self::listaTipo();

        //lista Regimen
        $listaRegimen = self::listaRegimen();

        return view('Administrativo.sedes', compact('listaTipoSede','listaRegional', 'listaEstados','listaDepartamentos', 'listaSeccional', 'listaTipo', 'listaRegimen') );
    }
