                ...
                <table class="table table-sm">                    
                        ...
                        <th colspan="4">
                            <div class="row">
                                ...
                                <div class="input-group col">
                                    ...
                                    <input type="number" class="form-control input-lg" id="numIdentServicio" name="numIdentServicio" v-model="nuevoDataRecobro.SERVICIO.SRS_NRO_ID_USUARIO" @change="busqAfiliado()" >
                                    <div class="input-group-append" v-if="consultando">
                                        <span class="input-group-text">
                                            <i class="fas fa-spinner fa-w-16 fa-spin"></i>
                                        </span>
                                    </div>
                    ...
                    <tr>    
                        <th colspan="4">
                             <div class="row">
                                <div class="col">
                                    <label for="" class="control-label text-primary" ><b>Nombres</b></label><br>   
                                    <input type="text" class="form-control input-lg" id="nombres_afi" name="nombres_afi" v-model="nuevoDataRecobro.SERVICIO.SRS_NOMBRES_AFI" >
                                </div>
                                <div class="col">
                                    <label for="" class="control-label text-primary"><b>Apellidos</b></label><br>   
                                    <input type="text" class="form-control input-lg" id="apellidos_afi" name="apellidos_afi" v-model="nuevoDataRecobro.SERVICIO.SRS_APELLIDOS_AFI" >
                                </div>
                            </div>                           
                        </th>
                    </tr>      
                    <tr>    
                        <th colspan="4">
                             <div class="row">
                                <div class="col">
                                    <label for="" class="control-label text-primary" ><b>Fecha Afiliación</b></label><br>   
                                    <input type="text" class="form-control input-lg" id="fecha_afi" name="fecha_afi" v-model="nuevoDataRecobro.SERVICIO.SRS_FECHA_AFILIAC" >
                                </div>
                                <div class="col">
                                    <label for="" class="control-label text-primary"><b>Fecha Retiro</b></label><br>   
                                    <input type="text" class="form-control input-lg" id="fecha_afireti" name="fecha_afireti" v-model="nuevoDataRecobro.SERVICIO.SRS_FECHA_RETIRO" >
                                </div>
                            </div>                           
                        </th>
                    </tr>                    
    ...
    methods:{     
        ...
        busqAfiliado(){ 
            this.consultando = true;   
             axios.post(`visor-afiliado`,{
                numafi: this.nuevoDataRecobro.SERVICIO.SRS_NRO_ID_USUARIO,
                tipafi: this.nuevoDataRecobro.SERVICIO.SRS_TIPO_ID_USUARIO
            })
           .then(resp => {
               this.consultando = false;
               if(!resp.data.NOMBRES){
                    this.nuevoDataRecobro.SERVICIO.SRS_NOMBRES_AFI = '';   
                    this.nuevoDataRecobro.SERVICIO.SRS_APELLIDOS_AFI = '';     
                    this.nuevoDataRecobro.SERVICIO.SRS_FECHA_AFILIAC = '';   
                    this.nuevoDataRecobro.SERVICIO.SRS_FECHA_RETIRO = '';   
                    return Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Afiliado no encontrado!'
                    })
               }                
                this.nuevoDataRecobro.SERVICIO.SRS_NOMBRES_AFI = resp.data.NOMBRES;   
                this.nuevoDataRecobro.SERVICIO.SRS_APELLIDOS_AFI = resp.data.APELLIDOS;   
                this.nuevoDataRecobro.SERVICIO.SRS_FECHA_AFILIAC = resp.data.FEC_AFILIA;   
                this.nuevoDataRecobro.SERVICIO.SRS_FECHA_RETIRO = resp.data.FEC_RETIRO;                 
           })
           .catch(error => {
               alert(error);
               this.consultando = false;
