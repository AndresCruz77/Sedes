            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Buscador de Recobros</h5>
                                ...
                                <thead class="thead-inverse">
                                    ...
                                    <tbody>
                                        <tr v-for="(item,index) in facturasEncontradas" :key="item.MRS_ID">
                                            ...
                                            <td><div class='row-sm-2 row-sm-2'><button type='button' v-on:click="seleccionarRecobro(item,index)" data-dismiss="modal" class='btn btn-primary btn-block'><span>Consultar</span></button></div></td>
                                        </tr>  
                                    </tbody>
                            </table>
                        </div>
                ...
                <table id="example" class="table  ">
                    ...
                    <tbody>               
                        <tr v-for="(item,index) in listarecobros" :key="item.MRS_ID">
                            ...
                            <td><div class='row-sm-2 row-sm-2'><button type='button' v-on:click="seleccionarRecobro(item,index)" class='btn btn-primary btn-block'><span>Consultar</span></button></div></td>
                        </tr>                                                           
                    </tbody>
                    <tfoot>
                        <tr>
